...
// creating UUIDs from exisiting data
//
...
func SwitchFormat(pFormat UUIDFormat, pUpperCase bool) {
	switch pFormat {
	case Clean:
		format = "%x%x%x%x%x%x"
	case Curly:
...
// not strictly required but have kept for reference
